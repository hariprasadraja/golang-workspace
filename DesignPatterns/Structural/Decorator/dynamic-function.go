// This file implements Decortor pattern which adds functionality to the existing function PI.
// source: https://github.com/tensor-programming/pattern-tutorial/blob/master/decorator/main.go
