// This file provides an simple exmple of Observer pattern in Golang
// source: https://github.com/tensor-programming/pattern-tutorial/blob/master/observer/main.go
// This Logic is so worse. If you already no golang weel. dont look at this code. you will hate it.
...
type (
	...
	//Event that has to occur.
	Event struct {
		data int
	}

	// Observer observers an particular event
	Observer interface {
		NotifyCallback(Event)
	}

	// Subject can be any thing which has multiple events to occur.
	//  example: a window which has events like 'open' and 'close'
	Subject interface {
